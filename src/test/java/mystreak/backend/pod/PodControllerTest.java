...
class PodControllerTest {
    ...
    void getMyPodsReturnsPods() throws Exception {
        when(podService.getMyPods()).thenReturn(List.of(pod()));
    ...
    void createPodReturnsCreatedPod() throws Exception {
        when(podService.createPod(any(CreatePodRequest.class))).thenReturn(pod());
    ...
    void joinPodUsesInviteCode() throws Exception {
        when(podService.joinPod(any(JoinPodRequest.class))).thenReturn(pod());
    ...
    void leavePodReturnsNoContent() throws Exception {
        ...
        verify(podService).leavePod("running");
    }
